...
DEFAULT_TO_KEY = "tri1cHBy47fPyhCvrCf6FnR7Mz6XdSoSBah2FsZVQeT"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 5:
        ...
        try:
            ...
            epoch = None
        rpc_endpoint = sys.argv[4]
    elif len(sys.argv) > 1:
        print("Please provide all parameters (from_key, to_key, epoch, rpc_endpoint) or none.")
        print("Usage: python find_sol_transfers.py [from_key] [to_key] [epoch] [rpc_endpoint]")
