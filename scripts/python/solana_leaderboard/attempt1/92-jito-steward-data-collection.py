...
def generate_steward_file(epoch):
    ...
    # /home/smilax/stakenet/target/debug/steward-cli --json-rpc-url https://side-silent-county.solana-mainnet.quiknode.pro/2ffa9d32adcd0102e7b78a8ba107f5c49b9420d8/ view-state --steward-config jitoVjT9jRUyeXHzvCwzPgHj7yWNRhLcUoXtes4wtjv --verbose
    ...
    command = [
        '/home/smilax/stakenet/target/debug/steward-cli',
