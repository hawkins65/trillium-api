...
log_message "INFO" "A copy with timestamp has been created in the current directory"
log_message "INFO" "File '$filename' has been successfully copied to /var/www/html/json/"
log_message "INFO" "You can access it as: https://trillium.so/json/$filename"
