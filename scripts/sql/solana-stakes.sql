...
\copy (SELECT * FROM calc ORDER BY total_active_stake DESC) TO '/home/smilax/trillium_api/data/exports/1_total_stake_by_vote_account.csv' CSV HEADER;
...
\copy (SELECT * FROM calc ORDER BY total_active_stake DESC) TO '/home/smilax/trillium_api/data/exports/2a_total_stake_by_staker.csv' CSV HEADER;
...
\copy (SELECT * FROM calc ORDER BY total_active_stake DESC) TO '/home/smilax/trillium_api/data/exports/2b_total_stake_by_withdrawer.csv' CSV HEADER;
...
\copy (SELECT * FROM calc ORDER BY total_active_stake DESC) TO '/home/smilax/trillium_api/data/exports/2c_total_stake_by_custodian.csv' CSV HEADER;
...
\copy (SELECT * FROM calc ORDER BY total_active_stake DESC) TO '/home/smilax/trillium_api/data/exports/3_aggregate_totals.csv' CSV HEADER;
...
\copy (SELECT * FROM calc ORDER BY avg_active_stake DESC) TO '/home/smilax/trillium_api/data/exports/4_active_stake_distribution.csv' CSV HEADER;
...
) TO '/home/smilax/trillium_api/data/exports/5_zero_active_stake_accounts.csv' CSV HEADER;
...
) TO '/home/smilax/trillium_api/data/exports/6a_accounts_per_vote_account.csv' CSV HEADER;
...
\copy (SELECT epoch, custodian,
    ...
    GROUP BY epoch, custodian
    ORDER BY account_count DESC
) TO '/home/smilax/trillium_api/data/exports/6b_accounts_per_custodian.csv' CSV HEADER;
...
\copy (SELECT * FROM calc ORDER BY total_active_stake DESC) TO '/home/smilax/trillium_api/data/exports/7_stake_changes_for_specific_vote_account.csv' CSV HEADER;
