...
execute_with_logging "bash $TRILLIUM_SCRIPTS_BASH/copy-pages-to-web.sh ${TRILLIUM_LEADERBOARD_HTML}/validator_performance_histogram_epoch${epoch_number}.html" "copying histogram to web" "🌐"
